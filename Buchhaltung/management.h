...
public:
	...
	explicit management ( const std::initializer_list<category> p_CategorieList, const std::initializer_list<person> p_PersonList, const std::initializer_list<payments_account> p_AccountList); // Normalfall
	~management ( );
	double GetBilance ( );
private:
	...
	std::vector<payments_account> m_AccountList;
};
